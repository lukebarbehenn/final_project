...
def test_getweather():
    ...
    assert weather.getweather(dc_lat, dc_lon)
    assert weather.getweather(arl_lat, arl_lon)
    assert weather.getweather(alx_lat, alx_lon)
    assert weather.getweather(bsd_lat, bsd_lon)
    assert weather.getweather(cp_lat, cp_lon)
